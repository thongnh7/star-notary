...
contract StarNotary is ERC721 {
    ...
    //string public name = "Thong's Star Notary";
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    //string public symbol = "TSN";

    constructor() public ERC721("Thong Star Notary", "TSN") {
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId2), "You can't exchange the Star you don't owned");
